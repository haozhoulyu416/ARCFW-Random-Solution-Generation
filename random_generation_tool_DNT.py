...
p = creation_population_time(pop_size)

fitness_value_transferred_data = []
fitness_value_page_load_time = []
...
for i in range(pop_size):
    ...
    fitness_value_page_load_time.append(p[i].fitness_page_load_time)
...
print("Fitness Value_Pgae load time: ", fitness_value_page_load_time)
